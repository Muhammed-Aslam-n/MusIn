...
var isSelected = true;
var songName, artistName, path, image, type;
...
class _SongsListMainState extends State<SongsListMain> {
  ...
  //   return ValueListenableBuilder(valueListenable: songDbInstance!.listenable(), builder: (context,Box<SongDetailsList>songFetcher,_){
  ...
  //                   nameOfSong: songDatas.songName,
  //                   nameOfArtist: songDatas.artistName,
  //                   artistImage: songDatas.songId,
  //                   artistType: ArtworkType.AUDIO,
  //                   songPath: songDatas.path);
  //             },
  //             child: Container(
  ...
  //                       child: commonText(
  //                           text:
  //                           songDatas.artistName ?? "No Artist",
  ...
  //                       child: commonText(
  //                           text: songDatas.songName, size: 17),
  //                     ),
  //                   ),
  //                   const SizedBox(
  //                     height: 7,
